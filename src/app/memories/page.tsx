      ...
      <div className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto mb-8">
            Relive the best moments from our time at Bahirdar University
          ...
          {!session && (
            <div className="space-y-4">
              <p className="text-blue-200">
                Sign in to share your own memories
              </p>
              <Button
                variant="outline"
                className="border-white text-white hover:bg-white/10 mr-4 bg-transparent"
                asChild
              >
                <Link href="/auth/login">Sign In</Link>
              </Button>
          ...
          {memories.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-8">
                Be the first to share a memory from your time at BDU!
              </p>
              {session && (
                <Button asChild>
