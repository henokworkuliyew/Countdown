    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="py-16 md:py-24 container mx-auto px-4 relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-0 right-0 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        </div>

        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold text-blue-900 mb-4">
              Computer Science <span className="text-yellow-600">Graduation</span>
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Celebrate Together</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Countdown Timer</h3>
            ...
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Chat with Classmates</h3>
              <p className="text-gray-600">Connect with your fellow graduates and share your experiences and plans.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {latestMemories.length > 0 && (
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Latest Memories</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {latestMemories.map((memory) => (
                <div key={memory._id.toString()} className="bg-white rounded-lg overflow-hidden shadow-md">
